...
Word16  Ordered_array[750];     /* 2 vocoder frames + 8 + 4 */
...
/* Init for channel encoder */
		if (!Frame_Stealing)
			...
			Nber_Info_Bits = Fs_N0_Tot + Fs_N1_Tot + Fs_N2_Tot + Fs_SIZE_CRC; 
